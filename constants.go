...
// The USBTMC standard refers to these as the bInterfaceClass.
const (
	audioBaseClass               bInterfaceClass = 0x01
	communicationsBaseClass      bInterfaceClass = 0x02
	hidBaseClass                 bInterfaceClass = 0x03
	physicalBaseClass            bInterfaceClass = 0x05
	imageBaseCalss               bInterfaceClass = 0x06
	misellaneousBaseClass        bInterfaceClass = 0xef
	applicationSpecificBaseClass bInterfaceClass = 0xfe
	vendorSpecificBaseClass      bInterfaceClass = 0xff
)
